    ...
    public class MySqlConnectionFrm : Form
    {
        ...
        public MySQL_Connection Connection
        {
            get
            {
                ...
                {
                    this._connection.ConnectionString = DESEncrypt.Encrypt(string.Concat(new object[] { "server=", DESEncrypt.Decrypt(this._connection.server), ";port=", this._connection.port, ";uid=", DESEncrypt.Decrypt(this._connection.user), ";pwd=", DESEncrypt.Decrypt(this._connection.password), "; database=", DESEncrypt.Decrypt(this._connection.database), ";" }));
                }
