...
namespace ScadaWeb.Repository
{
    public class BaseRepository<T> : IBaseRepository<T> where T : class, new()
    {
        ...
        public long InsertAndId(T model)
        {
            using (var conn = MySqlHelper.GetConnection())
            {
                return conn.InsertIdentity<T>(model);
            }
        }
        /// <summary>
        /// 根据主键修改数据
        ...
        /// 根据主键修改数据 修改指定字段
        /// </summary>
        public long UpdateById(T model, string updateFields)
        {
            using (var conn = MySqlHelper.GetConnection())
            {
        ...
        /// 根据主键批量删除数据
        /// </summary>
        public long DeleteByIds(object Ids)
        {
            using (var conn = MySqlHelper.GetConnection())
            {
        ...
        /// 根据条件删除
        /// </summary>
        public long DeleteByWhere(string where)
        {
            using (var conn = MySqlHelper.GetConnection())
            {
