...
namespace ScadaWeb.Repository
{
    public class ButtonRepository : BaseRepository<ButtonModel>, IButtonRepository
    {
        ...
        /// <returns></returns>
        public IEnumerable<ButtonModel> GetButtonListByRoleIdModuleId(long roleId, long moduleId, PositionEnum position)
        {
        ...
        public IEnumerable<ButtonModel> GetButtonListByRoleIdModuleId(long roleId, long moduleId)
        {
            using (var conn = MySqlHelper.GetConnection())
            {
                string sql = @"SELECT b.* FROM roleauthorize a
                            ...
                            and a.ModuleId=@ModuleId
                            ORDER BY b.SortCode";
                return conn.Query<ButtonModel>(sql, new { RoleId = roleId, ModuleId = moduleId});
            }
        }
        ...
        /// <returns></returns>
        public IEnumerable<ButtonModel> GetButtonListByRoleIdModuleId(long roleId, long moduleId, out IEnumerable<ButtonModel> selectList)
        {
            using (var conn = MySqlHelper.GetConnection())
            {
