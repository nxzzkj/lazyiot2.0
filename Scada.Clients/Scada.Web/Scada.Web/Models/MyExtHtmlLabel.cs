...
namespace ScadaWeb.Web
{
    ...
    {
        public static HtmlString BtnHtml(this HtmlHelper helper, string title = "按钮", string _class = "",string filter="")
        {
            return new HtmlString(string.Format(@"<button class='layui-btn {1}' lay-submit='' lay-filter='"+ filter + @"'>
