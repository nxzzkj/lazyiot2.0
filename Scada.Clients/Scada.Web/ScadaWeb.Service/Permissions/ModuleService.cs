...
namespace ScadaWeb.Service
{
    public class ModuleService : BaseService<ModuleModel>, IModuleService
    {
        ...
        /// <returns></returns>
        public dynamic GetModuleList(long roleId)
        {
        ...
        private void GetModuleListByModuleId(List<Tree> treeList, IEnumerable<ModuleModel> allMenus, Tree tree, long moduleId)
        {
        ...
        /// <param name="roleId"></param>
        /// <returns></returns>
        private IEnumerable<ModuleModel> GetModuleListByRoleId(long roleId)
        {
        ...
        /// 递归遍历treeSelectList
        /// </summary>
        private void GetModuleChildren(List<TreeSelect> treeSelectList, IEnumerable<ModuleModel> moduleList, TreeSelect tree, long id)
        {
        ...
        /// <returns></returns>
        public IEnumerable<ModuleModel> GetModuleButtonList(long roleId)
        {
