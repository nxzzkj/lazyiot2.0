...
namespace ScadaWeb.Service
{
    public class RoleAuthorizeService : BaseService<RoleAuthorizeModel>, IRoleAuthorizeService
    {
        ...
        /// <returns></returns>
        public int SavePremission(IEnumerable<RoleAuthorizeModel> entitys, long roleId)
        {
        ...
        /// <returns></returns>
        public IEnumerable<RoleAuthorizeModel> GetListByRoleIdModuleId(long roleId, long moduleId)
        {
