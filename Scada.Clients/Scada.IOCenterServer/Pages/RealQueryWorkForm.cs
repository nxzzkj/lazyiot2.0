    ...
    public partial class RealQueryWorkForm : DockForm
    {
        ...
        public void InitDevice(IO_SERVER server, IO_COMMUNICATION communication, IO_DEVICE device)
        {
            ...
            if (Device != null)
            {
                ...
                realtimer.Interval = Device.IO_DEVICE_UPDATECYCLE;
            ...
            if (Device != null)
            {
                realtimer.Interval = this.Device.IO_DEVICE_UPDATECYCLE;
        ...
        public RealQueryWorkForm()
        {
            ...
            this.FormClosed += RealQueryWorkForm_FormClosed;
        }

        private void RealQueryWorkForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.realtimer.Stop();
        ...
        private void hsComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (hsComboBox.SelectedItem != null)
            {
                ...
                if (this.Device != node.Device)
                {
                    ...
                    this.realtimer.Interval = this.Device.IO_DEVICE_UPDATECYCLE;
                    InitListView();
                    InitSeires();
