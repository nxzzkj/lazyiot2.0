...
namespace ScadaCenterServer.Pages
{
    ...
    /// 
    /// </summary>
    public partial class ScadaMachineTrainForeastQueryWorkForm : DockForm
    {
        ...
        public ScadaMachineTrainForeastQueryWorkForm()
        {
            InitializeComponent();
        ...
        public ScadaMachineTrainForeastQueryWorkForm(Mediator m):base(m)
        {
            InitializeComponent();
            this.Load += RealAlarmQueryWorkForm_Load;
        ...
        private void Search_SearchClick(object sender, EventArgs e)
        {
            if (sender != null)
            {
                ...
                this.ScadaMachineTraining = this.search.MachineTrainingModel;
                this.Server = this.search.Server;
                ReadMachineTrainForeastHistory();
            }
        ...
        private async void ReadMachineTrainForeastHistory()
        {
            try
            {
                ...
                if (resultData.Seres.Count() > 0)
                {
                    ...
                    {   
                        ...
                        int field_taskname = s.Columns.IndexOf("field_taskname");
                        if (field_taskname >= 0)
                        {
                            lvi.SubItems.Add(InfluxDbManager.GetInfluxdbValue(s.Values[i][field_taskname]));
                        }
                        else
                        {
                            lvi.SubItems.Add("");
                        }
                        int field_predicteddate = s.Columns.IndexOf("field_predicteddate");
                        if (field_predicteddate >= 0)
                        {
                            lvi.SubItems.Add(InfluxDbManager.GetInfluxdbValue(s.Values[i][field_predicteddate]));
                        }
                        else
                        {
                            lvi.SubItems.Add("");
                        ...
                        int field_predictedlabel = s.Columns.IndexOf("field_predictedlabel");
                        if (field_predictedlabel >= 0)
                        {
                            lvi.SubItems.Add(InfluxDbManager.GetInfluxdbValue(s.Values[i][field_predictedlabel]));
                        }
                        else
                        {
                            lvi.SubItems.Add("");
                        ...
                        int field_score = s.Columns.IndexOf("field_score");
                        if (field_score >= 0)
                        {
                            lvi.SubItems.Add(InfluxDbManager.GetInfluxdbValue(s.Values[i][field_score]));
                        }
                        else
                        {
                            lvi.SubItems.Add("");
                        ...
                        int field_featuresname = s.Columns.IndexOf("field_featuresname");
                        if (field_featuresname >= 0)
                        {
                            lvi.SubItems.Add(InfluxDbManager.GetInfluxdbValue(s.Values[i][field_featuresname]));
                        }
                        else
                        {
                            lvi.SubItems.Add("");
                        ...
                        int field_featuresvalue = s.Columns.IndexOf("field_featuresvalue");
                        if (field_featuresvalue >= 0)
                        {
                            lvi.SubItems.Add(InfluxDbManager.GetInfluxdbValue(s.Values[i][field_featuresvalue]));
                        }
                        else
                        {
                            lvi.SubItems.Add("");
                        ...
                        int field_algorithm = s.Columns.IndexOf("field_algorithm");
                        if (field_algorithm >= 0)
                        {
                            lvi.SubItems.Add(InfluxDbManager.GetInfluxdbValue(s.Values[i][field_algorithm]));
                        }
                        else
                        {
                            lvi.SubItems.Add("");
                        ...
                        int field_algorithmtype = s.Columns.IndexOf("field_algorithmtype");
                        if (field_algorithmtype >= 0)
                        {
                            lvi.SubItems.Add(InfluxDbManager.GetInfluxdbValue(s.Values[i][field_algorithmtype]));
                        }
                        else
                        {
                            lvi.SubItems.Add("");
