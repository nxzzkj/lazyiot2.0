...
namespace Scada.Model
{
    ...
    /// </summary>
    [Serializable]
    public partial class IO_PARA:ISerializable, IDisposable
    {
        public IO_PARA()
        {
        ...
        public string GetCommandString()
        {
            try
            {
                ...
                str += "#IO_SIMULATOR_MAX:" + this.IO_SIMULATOR_MAX;
                str += "#IO_SIMULATOR_MIN:" + this.IO_SIMULATOR_MIN;
                //增加报警信息的配置
        ...
        public IO_PARA Copy()
        {
            ...
            IO_PARA para= new IO_PARA() {
                ...
                IO_SIMULATOR_MAX = this.IO_SIMULATOR_MAX,
                IO_SIMULATOR_MIN = this.IO_SIMULATOR_MIN
        ...
        private int _IO_SIMULATOR_MAX = 100;
        public int IO_SIMULATOR_MAX { set { _IO_SIMULATOR_MAX = value; } get { return _IO_SIMULATOR_MAX; } }
 
        private int _IO_SIMULATOR_MIN = -100;
        public int IO_SIMULATOR_MIN { set { _IO_SIMULATOR_MIN = value; } get { return _IO_SIMULATOR_MIN; } }
        #endregion
        ...
        protected IO_PARA(SerializationInfo info, StreamingContext context)
        {
           ...
           // this.mIORealData = (IOData)info.GetValue("mIORealData", typeof(IOData));
            ...
            this._IO_SIMULATOR_MAX = (int)info.GetValue("_IO_SIMULATOR_MAX", typeof(int));
            this._IO_SIMULATOR_MIN = (int)info.GetValue("_IO_SIMULATOR_MIN", typeof(int));
            #endregion
        }
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
           ...
           // info.AddValue("mIORealData", this.mIORealData);
            ...
            info.AddValue("_IO_SIMULATOR_MAX", this._IO_SIMULATOR_MAX);
            info.AddValue("_IO_SIMULATOR_MIN", this._IO_SIMULATOR_MIN);
        ...
        {
            if (this.AlarmConfig != null)
                this.AlarmConfig.Dispose();
            this.AlarmConfig = null;
            if (this.IORealData != null)
                this.IORealData.Dispose();
            this.IORealData = null;
