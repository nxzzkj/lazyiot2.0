	...
	public partial class IO_DEVICE: IDisposable
	{
        ...
        public void Add(List<Scada.Model.IO_DEVICE> models)
        {
            ...
            for(int i=0;i< models.Count;i++)
            {
				...
				if (model.IO_DEVICE_SIMULATOR_PARASTRING != null)
				{
					strSql1.Append("IO_DEVICE_SIMULATOR_PARASTRING,");
					strSql2.Append("'" + model.IO_DEVICE_SIMULATOR_PARASTRING + "',");
				}
				...
				if (model.DataPushUrl != null)
				{
					strSql1.Append("DataPushUrl,");
					strSql2.Append("'" + model.DataPushUrl + "',");
				}
		...
		public void Add(ConcurrentBag<Scada.Model.IO_DEVICE> models)
		{
			...
			{
				Scada.Model.IO_DEVICE model;
				models.TryTake(out model);
				if (model == null)
					continue;
				model.IO_DEVICE_STATUS = 0;
				StringBuilder strSql = new StringBuilder();
        ...
        public bool Update(Scada.Model.IO_DEVICE model)
		{
			...
			if (model.IO_DEVICE_SIMULATOR_PARASTRING != null)
			{
				strSql.Append("IO_DEVICE_SIMULATOR_PARASTRING='" + model.IO_DEVICE_SIMULATOR_PARASTRING + "',");
			}
			...
			if (model.DataPushUrl != null)
			{
				strSql.Append("DataPushUrl='" + model.DataPushUrl + "',");
			}
        ...
        public Scada.Model.IO_DEVICE GetModel(string IO_DEVICE_ID)
		{
           ...
           StringBuilder strSql=new StringBuilder();
			...
			strSql.Append(" IO_DEVICE_ID,IO_COMM_ID,IO_SERVER_ID,IO_DEVICE_NAME,IO_DEVICE_LABLE,IO_DEVICE_REMARK,IO_DEVICE_UPDATECYCLE,IO_DEVICE_STATUS,IO_DEVICE_OVERTIME,IO_DEVICE_ADDRESS,IO_DEVICE_PARASTRING,DEVICE_DRIVER_ID,IO_DEVICE_SIMULATOR_PARASTRING,DataPushUrl ");
        ...
        public Scada.Model.IO_DEVICE DataRowToModel(DataRow row,List<Model.SCADA_DEVICE_DRIVER> Drives)
		{
			...
			if (row != null)
			{
				...
				if (row["IO_DEVICE_SIMULATOR_PARASTRING"] != null)
				{
					model.IO_DEVICE_SIMULATOR_PARASTRING = row["IO_DEVICE_SIMULATOR_PARASTRING"].ToString();
				}
				...
				if (row["DataPushUrl"] != null)
				{
					model.DataPushUrl = row["DataPushUrl"].ToString();
				}
        ...
        public DataSet GetList(string strWhere)
		{
			...
			strSql.Append("	 order by IO_DEVICE_NAME ASC ");
