     ...
     public void Add(List<Scada.Model.IO_COMMUNICATION> models)
        {
            ...
            for(int i=0;i< models.Count;i++)
            {
				...
				if (model.IO_SERVER_ID != null)
				{
					strSql1.Append("IO_COMM_SIMULATOR_PARASTRING,");
					strSql2.Append("'" + model.IO_COMM_SIMULATOR_PARASTRING + "',");
				}
		...
		public bool Add(Scada.Model.IO_COMMUNICATION model)
		{
			...
			if (model.IO_COMM_SIMULATOR_PARASTRING != null)
			{
				strSql1.Append("IO_COMM_SIMULATOR_PARASTRING,");
				strSql2.Append("'" + model.IO_COMM_SIMULATOR_PARASTRING + "',");
			}
        ...
        public bool Update(Scada.Model.IO_COMMUNICATION model)
		{
			...
			if (model.IO_COMM_SIMULATOR_PARASTRING != null)
			{
				strSql.Append("IO_COMM_SIMULATOR_PARASTRING='" + model.IO_COMM_SIMULATOR_PARASTRING + "',");
			}
			else
			{
				strSql.Append("IO_COMM_SIMULATOR_PARASTRING= null ,");
			}
        ...
        public Scada.Model.IO_COMMUNICATION GetModel(string IO_COMM_ID)
		{
			...
			strSql.Append(" IO_COMM_ID,IO_COMM_NAME,IO_COMM_LABEL,IO_COMM_REMARK,IO_COMM_STATUS,IO_COMM_DRIVER_ID,IO_SERVER_ID,IO_COMM_PARASTRING,IO_COMM_SIMULATOR_PARASTRING ");
		...
		public Scada.Model.IO_COMMUNICATION DataRowToModel(DataRow row)
		{
			...
			if (row != null)
			{
				...
				if (row["IO_COMM_SIMULATOR_PARASTRING"] != null)
				{
					model.IO_COMM_SIMULATOR_PARASTRING = row["IO_COMM_SIMULATOR_PARASTRING"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select IO_COMM_ID,IO_COMM_NAME,IO_COMM_LABEL,IO_COMM_REMARK,IO_COMM_STATUS,IO_COMM_DRIVER_ID,IO_SERVER_ID,IO_COMM_PARASTRING,IO_COMM_SIMULATOR_PARASTRING ");
			strSql.Append(" FROM IO_COMMUNICATION  where IO_COMM_STATUS=0    ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" and  "+strWhere);
			}
			strSql.Append("	order by IO_COMM_NAME ASC ");
