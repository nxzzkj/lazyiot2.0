    ...
    public  class ScadaDeviceKernel : IDisposable
    {
        ...
        public IOData AnalysisData(IO_SERVER server, IO_COMMUNICATION Communication, IO_DEVICE device, IO_PARA para, byte[] datas, DateTime datatime, object sender)
        {
            try
            {
                ...
                if (data != null)
                {
                    if (string.IsNullOrEmpty(data.ParaValue))
                    {
                        data.ParaValue = "-9999";
            ...
            {
                DeviceException("数据解析异常-"+emx.Message);
                return null;
            }
        }
        ...
        /// 程序异常的事件
        /// </summary>
        public event DeviceKernelError Exception;
        /// <summary>
        /// 程序异常处理
        /// </summary>
        ...
        protected   void DeviceException(string msg)
        {
            ...
            if (this.Exception != null)
                this.Exception(IOServer,IOCommunication,IODevice, msg);
        }
        /// <summary>
        /// 释放资源
        /// </summary>
