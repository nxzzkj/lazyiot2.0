...
namespace Modbus.Data
{
    ...
    public static class DataStoreFactory
    {
        ...
        internal static DataStore CreateTestDataStore(int regnum,ushort max,ushort min)
        {
            Random rd = new Random();
            DataStore dataStore = new DataStore();
            ...
            for (int i = 1; i < regnum; i++)
            {
                ...
                dataStore.CoilDiscretes.Add(value);//线圈
                dataStore.InputDiscretes.Add(!value);
                dataStore.HoldingRegisters.Add((ushort)rd.Next(min, max));
                dataStore.InputRegisters.Add((ushort)rd.Next(min, max));
            }
